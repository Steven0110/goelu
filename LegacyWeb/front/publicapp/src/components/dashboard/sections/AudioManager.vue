	...
	.audio-manager-panel
			...
			tr
				td
					.subsection-header-icon
						img(src="/assets/icons/ic_daudio_lg.svg")
				td
					.subsection-header-posticon
						img(src="/assets/icons/ic_header_daudio.svg")
				td
					.subsection-title
						|Audios
				td
					.subsection-description
						|Listen to all your audios
		.subsection-header.d-block.d-md-none
			...
			.subsection-description
				|Listen to all your audios
		.content
			v-data-table.audios-datatable(:headers="audioTableHeaders", :items="audioFiles", :loading="loadingFiles", loading-text="Loading audios", no-data-text="No audios available")
			...
			.v-data-table
				.v-data-table__wrapper
					...
					&::-webkit-scrollbar-thumb
						background-image: -webkit-gradient(linear,left bottom,left top,color-stop(0.44, #660BAB),color-stop(0.72, #660BAB),color-stop(0.86, #49047d))
				table
					width: 250%
					overflow-x: scroll
					margin-top: 110px
